...
<h2>Select Employee id to update </h2>
...
echo "<table border=1>\n";
echo "<tr><th>Emp Id</th><th>SSN</th><th>EmpFName</th><th>EmpLName</th><th>Emp Address</th><th>Emp Tele-no</th><th>Job Title</th><th>Gender</th><th>Hire Date</th><th>Supervisor Id</th><th>Office Id</th></tr>\n";
$i=0;
while ($i < $num) {
...
<br><br>
&nbsp;<b>Property Id:</b> <input type="text" name="Employee Id"/><br><br>
&nbsp;&nbsp;<input type="Submit" value= "Select"/> &nbsp;&nbsp;<input type="Reset"/><br><br>
<br/>
</form>
